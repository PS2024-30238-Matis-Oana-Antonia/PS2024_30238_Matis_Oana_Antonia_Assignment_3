...
public class EmailService {
    ...
    public void sendEmailWithAttachment(NotificationRequestDTO notificationRequestDTO, byte[] attachmentData) {
        try {
            String jsonPayload = objectMapper.writeValueAsString(notificationRequestDTO);
            MimeMessage message = javaMailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);
            ...
            helper.addAttachment("OrderBill.pdf", new ByteArrayResource(attachmentData));
